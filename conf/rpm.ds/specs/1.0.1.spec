...
if [ "$1" = "1" ]; then
  ...
  # copy over the config.ini only the first time
  cp /home/ds/init/install_sample.ini /home/ds/init/config.ini
  ...
  echo "    virtual host and add your API server url to the config.ini file.  A"
